...
class Vector3 {
    ...
    static cross(other1, other2) {
		...
		let v1x = other1.elements[0], v1y = other1.elements[1], v1z = other1.elements[2];
		let v2x = other2.elements[0], v2y = other2.elements[1], v2z = other2.elements[2];
        let v3 = new Vector3([((v1y*v2z)-(v1z*v2y)), -((v1x*v2z)-(v1z*v2x)), ((v1x*v2y)-(v1y*v2x))]); 
        return v3;
    }
